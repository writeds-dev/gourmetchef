...
import SpiceCate from './categories/page';
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
            <div className="lg:col-span-2 lg:row-span-2 relative h-[400px] overflow-hidden">
              ...
              <div className="absolute bottom-5 left-5 text-white z-10">
                <h2 className="text-3xl font-bold">SEASONING</h2>
                <p className="text-xl font-semibold">BLENDS</p>
              </div>
            </div>

            <div className="relative h-[195px] rounded-xl overflow-hidden">
              <Image
                src="https://img.freepik.com/free-photo/boxes-arrangement-logistic-center_23-2148902540.jpg"
                alt="Bulk Wholesale"
                fill
                className="object-cover"
              />
              ...
              <div className="absolute bottom-4 left-4 text-white">
                <h2 className="text-2xl font-bold">BULK</h2>
                <p className="text-lg font-medium">WHOLESALE</p>
              </div>
            </div>

            <div className="relative h-[195px] rounded-xl overflow-hidden">
              <Image
                src="https://img.freepik.com/premium-photo/group-indian-spices_55610-2828.jpg"
                alt="Spices"
                fill
                className="object-cover"
              />
            ...
            <div className="relative h-[195px] lg:col-span-2 rounded-xl overflow-hidden">
              <Image
                src="/demo/m-4.jpeg"
                alt="New Products"
                fill
          ...
          <div className="flex flex-col lg:flex-row gap-10 mb-12">
            ...
            <div className="lg:w-2/3 bg-white p-8 rounded-lg shadow-lg">
              <h2 className="text-3xl sm:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#A65F00] to-[#d97700] mb-6">
                SPICES & MASALA PRODUCTS
              </h2>
              <p className="text-gray-700 text-base sm:text-lg mb-6">
                Discover the essence of flavor with our wide range of Spices & Masala Products. From everyday staples to regional blends, our collection brings depth, aroma, and authenticity to your kitchen. Whether you are simmering a curry, seasoning grilled meats, or perfecting a cup of chai, our premium-quality spices ensure every dish is rich in tradition and taste.
              </p>
              <div className="bg-gray-100 p-6 rounded-md">
                <h3 className="text-2xl font-bold mb-3">Full-Service Spice Supply</h3>
                <p className="text-lg mb-5">
                  Gourmet Chef is a leader in the import, manufacture, and distribution of a variety of premium spices from around the world.
                </p>
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <Link
                    href="/contact"
                    passHref
                    className="bg-yellow-500 text-black px-6 py-2 rounded-lg hover:bg-yellow-600 transition flex items-center gap-2"
                  >
                    <FaEye />
